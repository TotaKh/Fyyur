...
def venues():
  ...
  all_cites = Venue.query.with_entities(Venue.city, Venue.state).group_by(Venue.city, Venue.state).all()
  data = []
...
def show_artist(artist_id):
  ...
  # TODO: replace with real artist data from the venues table, using artist_id .. done
